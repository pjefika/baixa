...
public class EfikaUsersProxy implements auth.dal.webservice.EfikaUsers_PortType {
  private String _endpoint = null;
  private auth.dal.webservice.EfikaUsers_PortType efikaUsers_PortType = null;
  ...
  private void _initEfikaUsersProxy() {
    try {
      efikaUsers_PortType = (new auth.dal.webservice.EfikaUsers_ServiceLocator()).get_8();
  ...
  public auth.dal.webservice.EfikaUsers_PortType getEfikaUsers_PortType() {
    if (efikaUsers_PortType == null)
      _initEfikaUsersProxy();
