...
public class EfikaUsers_ServiceLocator extends org.apache.axis.client.Service implements auth.dal.webservice.EfikaUsers_Service {
    ...
    public auth.dal.webservice.EfikaUsers_PortType get_8(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(@SuppressWarnings("rawtypes") Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (auth.dal.webservice.EfikaUsers_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                auth.dal.webservice.EfikaUsersSoapBindingStub _stub = new auth.dal.webservice.EfikaUsersSoapBindingStub(new java.net.URL(_8_address), this);
                _stub.setPortName(get_8WSDDServiceName());
                return _stub;
            }
