    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/baixa/index/">Back Office - Baixa Off Line</a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">

                    <li><a href="${linkTo[BaixaController].index()}">Home</a></li>
                    <li><a href="${linkTo[BaixaController].atendimento()}">Registro Baixa</a></li><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Painel Encerramento <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li class="dropdown-header">Baixa</li>
                            <li><a href="${linkTo[BaixaController].backlistba()}">BA</a></li>
                            <li><a href="${linkTo[BaixaController].backlisttt()}">TT</a></li>
                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Administração <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li class="dropdown-header">Relatórios</li>
                            <li><a href="/baixa/relatorio/create">Base</a></li>
                            <li role="separator" class="divider"></li>
                            <li class="dropdown-header">Cadastros</li>
                            <li><a href="/baixa/rede">Rede</a></li>
                            <li><a href="/baixa/macroMotivo">Motivo de Suporte</a></li>
                            <li><a href="/baixa/motivo">Defeito Encontrado</a></li>
                            <li><a href="/baixa/solucao">Solução</a></li>
                        </ul>
                    </li>
                </ul>
